  ...
  return (
    <>
      <div className="container">
        ...
        >
          <form
            className="h-[72vh] w-[82vw] bg-white flex  justify-center"
          ...
          >
            <div className="pt-4">
              ...
              <div className="flex flex-col gap-6 justify-center items-center">
                {mapping.map((item, index) => {
                  return (
                    <div className="flex items-center" key={index}>
                      <Icon
                        icon={item.icon}
                        className="absolute pl-2 text-3xl "
                      ></Icon>
                      <input
                        key={index}
                        ...
                        className="border border-black rounded-lg z-10 text-xl  w-[241px] h-[45px] pl-8"
                      ></input>
                    </div>
                  );
                })}
                ...
                <div className="flex gap-2  w-[241px]">
