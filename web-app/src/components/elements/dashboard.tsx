      ...
      >
        ...
        <div className="flex gap-12 flex-row">
          <div className="flex gap-4 max-sm:w-[20vw] max-sm:mr-3">
              ...
              >
                ...
                <div className="w-full h-[400px] bg-[#D3D3D3]">
                  {Notif.map((item, index) => (
                    <div
                      className="w-[388px] h-[100px]  flex items-center justify-center"
                      key={index}
                    >
                      <div className="w-[321px] h-[76px] flex flex-wrap gap-2">
                        <h1 className="font-bold">{item.activity}</h1>
                        <img
                          src={item.image}
                          alt="test"
            ...
            <div
              className={`w-[378px] h-[443px] absolute top-19 bg-[#F5F8FF] right-68 rounded-3xl ${
