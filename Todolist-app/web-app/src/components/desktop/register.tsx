                ...
                {mapping.map((item, index) => {
                  return (
                    <div key={index} className="flex items-center relative z-0">
                      <Icon
                        icon={item.icon}
                        className="text-4xl absolute pl-2 z-1"
                      ></Icon>
                      <input
                        key={index}
                        ...
                        className="2xl:h-[60px] 2xl:w-[559px] border border-black rounded-lg  2xl:text-xl 2xl:pl-12 max-sm:w-[281px] max-sm:h-[30px] pl-12"
                      ></input>
                    </div>
                  );
                })}
